        ...
        <section class="grid gap-6 lg:grid-cols-3">
            <div class="lg:col-span-2 space-y-4">
                <div class="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 space-y-3">
                    ...
                    <div class="rounded-lg border border-dashed border-slate-800 bg-slate-900/60 p-3 flex items-center gap-3">
                        <div class="p-2 rounded-md bg-slate-800/70 text-amber-200 text-xs font-semibold">Camera</div>
                        <div class="text-sm text-slate-200" id="permission-notice">
                            Allow camera access to scan barcodes. Your scans stay local until lookup.
                        </div>
                        <button id="permission-action" class="ml-auto px-3 py-2 text-xs rounded-md bg-slate-800 border border-slate-700 hover:border-emerald-400">Allow camera</button>
                    </div>
                    <div class="relative aspect-video overflow-hidden rounded-xl border border-slate-800 bg-slate-950">
                    ...
                    <div id="feedback" class="text-sm text-slate-200" data-level="info">Ready to capture.</div>
                </div>
